...
print('x to the power of 1.5 is: ' + str(x**1.5))
...
G = np.random.normal(size=5*5).reshape((5,5))
print(G)
...
dax = np.genfromtxt("time_series_dax_2022.csv",skip_header=True, delimiter=";", usecols=(3))
